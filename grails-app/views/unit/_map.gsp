...
<g:else>
  <td id="maptd" onmouseover="Tip('${field.fieldtype}</br>${field.xaxis}/${field.yaxis}</br>Monsterexp: ${field.monsterexp}</br>Nazipower: ${field.staerkefaktor}')" onmouseout="UnTip()">
</g:else>
