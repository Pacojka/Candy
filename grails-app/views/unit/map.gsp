<html>
  ...
  <div id="body1">
    ...
    <table>  
      ...
      <td><g:link action="map" params="[newx:xnow,newy:ynow-1,newrange:rangenow]"><h4>^</h4></g:link></td>
      <td></td>

      </tr>

      <tr width="380px">
        <td id="maptd"><g:link action="map" params="[newx:xnow-1,newy:ynow,newrange:rangenow]"><h4><</h4></g:link></td>
      <td width="380px">
      ...
      <tr>
        <td></td>
        <td><g:link action="map" params="[newx:xnow,newy:ynow+1,newrange:rangenow]"><h4>v</h4></g:link></td>
      <td>
